...
public class Main {
    ...
    public static final String BOOK_HAS_DUPS = "There are contacts that share phone numbers.";
    public static final String BOOK_NO_DUPS = "All contacts have different phone numbers.";
